module Clears
  class BuildClearFromVideo < ApplicationService
    def initialize(video, operator_name_only: true, language: nil)
    ...
    def call
      ...
      used_operators_attributes = ClearImage.new(
        image_path, { global: { operator_name_only: } }, language:
      ).used_operators_data
      clear_attrs = {
    ...
    attr_reader :video, :submitter, :operator_name_only, :language
  end
