class ClearImage::TestResult
  ...
  def compute!
    ...
    if result.success?
      ...
      clear_image = ClearImage.new(
        clear_image_path, used_configuration, log_data_path: data_folder_path, possible_languages: test_case.clear.channel.clear_languages
      )
      used_operators_data = clear_image.used_operators_data
      language = clear_image.used_language
