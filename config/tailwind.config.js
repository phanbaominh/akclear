...
svgToDataUri.toSrcset = function toSrcset(svgString) {
  return svgToDataUri(svgString).replace(/ /g, '%20');
}

// Copied from here https://github.com/themesberg/flowbite/blob/main/plugin.js
// Make sure to update this whenever updating flowbite version
...
const flowbitePlugin = function ({ addBase, theme }) {
  addBase({
    [[
      "[type='text']",
      "[type='email']",
...
module.exports = {
  ...
  plugins: [
    ...
    plugin(flowbitePlugin, flowbiteConfig),
  ],
};
